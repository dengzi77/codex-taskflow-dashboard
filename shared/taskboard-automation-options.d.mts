...
export type AutomationSandbox = "workspace-write" | "danger-full-access";
...
export const AUTOMATION_SANDBOXES: readonly AutomationSandbox[];
...
export function isAutomationSandbox(value: unknown): value is AutomationSandbox;
