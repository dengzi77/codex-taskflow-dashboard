...
export const AUTOMATION_SANDBOXES = ["workspace-write", "danger-full-access"];
...
const SANDBOXES = new Set(AUTOMATION_SANDBOXES);
...
export function isAutomationSandbox(value) {
  return SANDBOXES.has(value);
}
